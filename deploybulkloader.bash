...
(
		...
		stepresult=$(retry az functionapp deployment source config --branch master --manual-integration --name $faname --repo-url https://github.com/daemel/test --resource-group $resourceGroupName)
